...
def informacion(nombre='alguien', cargo='un vago'):
    # Se colocan valores por defecto para evitar errores si
    # falta algun parametro al llamar la funcion
...
# Funciones: vemos la fucnione y le psasmos un valor,
# ej: def suma(a, b): return a+ b

# metodos: tenemos la variable, un punto,
# y el nombre de la funcion/metodo, ej: variable.metodo()
