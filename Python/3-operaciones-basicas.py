...
print(f'La suma de a + b es igual a: {str(a)} + {str(b)} = {str(a + b)}')

# para concatenar variables numericas es necesario
# usar la funcion str() para convertir
# el valor en una cadena e texto o puedes usar
# la siguiente alternativa

print(f'La suma de a + b es igual a: {a} + {b} = {a + b}')
# que fue introducida a partir de la version 3.6
